...
const User = sequelize.define('User', {
    ...
    role: { type: DataTypes.ENUM('Admin', 'Manager', 'accounts_manager', 'Ads Manager', 'Staff', 'Student'), defaultValue: 'Staff' },
    status: {
...
const Student = sequelize.define('Student', {
    ...
    secondaryEmail: { type: DataTypes.STRING(255), allowNull: true },
    secondaryPhone: { type: DataTypes.STRING(20), allowNull: true },
    additionalContacts: { type: DataTypes.TEXT, allowNull: true }, // Stores JSON array of extra dynamic contact fields
...
const Setting = sequelize.define('Setting', {
    ...
    officialEmail: { type: DataTypes.STRING(255), allowNull: true, defaultValue: 'info@hunarasaan.edu' },
    officialWebsite: { type: DataTypes.STRING(255), allowNull: true, defaultValue: 'hunarasaan.edu' },
    address: { type: DataTypes.TEXT, allowNull: true },
    logoUrl: { type: DataTypes.TEXT('long'), allowNull: true },
    signatureUrl: { type: DataTypes.TEXT('long'), allowNull: true },
    signatureTitle: { type: DataTypes.STRING(255), allowNull: true, defaultValue: 'Authorized Signature' },
