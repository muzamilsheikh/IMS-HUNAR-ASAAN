                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex flex-wrap items-center gap-2 sm:gap-4 text-slate-400 text-xs">
                            ...
                            {student?.secondaryEmail && (
                                <>
                                    <div className="w-1.5 h-1.5 rounded-full bg-slate-200 hidden sm:block" />
                                    <div className="flex items-center gap-2" title="Secondary Email">
                                        <Mail size={14} className="text-blue-500 flex-shrink-0" />
                                        <span className="font-bold tracking-widest text-slate-600">
                                            Sec Email: {student.secondaryEmail}
                                        </span>
                                    </div>
                                </>
                            )}
                                ...
                                return contacts.filter(c => c && c.value && c.type !== 'Secondary Mobile' && c.type !== 'Secondary Email').map((c, i) => (
                                    <React.Fragment key={i}>
                                        ...
                                        <div className="flex items-center gap-2">
                                            {c.type?.includes('Email') ? <Mail size={14} className="text-secondary flex-shrink-0" /> : <Phone size={14} className="text-secondary flex-shrink-0" />}
                                            <span className="font-bold uppercase tracking-widest text-slate-600">
