...
// Serve uploaded files (branding, invoices, students, temp, certificates, etc.)
const path = require('path');
const fs = require('fs');
const uploadsDir = path.join(__dirname, 'uploads');
const uploadSubdirs = ['branding', 'invoices', 'students', 'temp', 'settings', 'certificates', 'slips', 'backups'];
