...
const Settings = () => {
    ...
    const [formData, setFormData] = useState({
        instituteName: '',
        contact: '',
        officialEmail: '',        // must be '' not undefined — avoids React uncontrolled warning
        officialWebsite: '',      // same
        address: '',
    ...
    useEffect(() => {
        if (settings) {
            setFormData({
                ...
                // Use ?? so that an empty string saved in DB is kept as-is (not replaced by a default)
                ...
                {activeTab === 'general' && (
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                        ...
                        <div className="lg:col-span-1 space-y-8">
                            ...
                            {/* Signature Stamp & PNG Upload Card */}
                            <div className="glass-card p-10 bg-white border border-slate-100 shadow-2xl relative overflow-hidden group">
                                <div className="absolute top-0 left-0 w-full h-2 bg-emerald-500" />
                                <p className="text-[10px] font-black uppercase text-slate-400 tracking-[0.3em] mb-4">Official Signature Stamp</p>
                                <p className="text-xs text-slate-400 mb-6 font-semibold">Upload a transparent PNG signature image or type your signature title to display on all Challans &amp; Vouchers.</p>

                                <div className="relative h-36 rounded-2xl overflow-hidden bg-slate-50 border-2 border-dashed border-slate-200 hover:border-emerald-500/60 transition-all flex flex-col items-center justify-center p-3 mb-6">
                                    {signaturePreview ? (
                                        <div className="w-full h-full flex flex-col items-center justify-center relative">
                                            <img src={signaturePreview} alt="Signature Stamp" className="max-h-24 object-contain" />
                                            {signatureFile && (
                                                <span className="text-[9px] font-black bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded-full mt-1 animate-bounce">
                                                    New PNG Selected — Click Deploy Config
                                                </span>
                                            )}
                                        </div>
                                    ) : (
                                        <div className="text-center p-2">
                                            <p className="text-xs font-bold text-slate-400 italic">No PNG signature uploaded</p>
                                            <p className="text-[10px] text-emerald-600 font-black uppercase tracking-wider mt-1 cursor-pointer">Click here to select PNG image</p>
                                        </div>
                                    )}
                                    <label htmlFor="signature-upload-input" className="absolute inset-0 bg-slate-900/70 opacity-0 hover:opacity-100 flex flex-col items-center justify-center cursor-pointer transition-all gap-2 z-10">
                                        <div className="w-10 h-10 bg-emerald-600 rounded-xl flex items-center justify-center text-white shadow-lg"><Upload size={18} /></div>
                                        <span className="text-[10px] font-black text-white uppercase tracking-widest">Choose PNG Signature</span>
                                    </label>
                                    <input id="signature-upload-input" type="file" className="hidden" accept="image/*" onChange={handleSignatureChange} />
                                </div>

                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase text-slate-400 tracking-widest ml-1">Signature Title / Designation</label>
                                    <div className="relative">
                                        <User className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-300" size={16} />
                                        <input
                                            type="text"
                                            className="input-field pl-12 bg-slate-50 focus:bg-white border-transparent focus:border-emerald-500/20 font-bold text-xs"
                                            placeholder="e.g. Authorized Signature / Director"
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input className="input-field pl-12 bg-slate-50 focus:bg-white border-transparent focus:border-secondary/20 font-bold text-xs" value={formData.instituteName} onChange={e => setFormData({ ...formData, instituteName: e.target.value })} />
                                        </div>
                                    </div>
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input className="input-field pl-12 bg-slate-50 focus:bg-white border-transparent focus:border-secondary/20 font-bold text-xs" value={formData.contact} onChange={e => setFormData({ ...formData, contact: e.target.value })} />
                                        </div>
                                    </div>
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                className="input-field pl-12 bg-slate-50 focus:bg-white border-transparent focus:border-secondary/20 font-bold text-xs"
                                                placeholder="e.g. info@hunarasaan.edu"
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black uppercase text-slate-400 tracking-widest ml-1">Official Website</label>
                                        <div className="relative">
                                            <Globe className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-300" size={16} />
                                            <input
                                                className="input-field pl-12 bg-slate-50 focus:bg-white border-transparent focus:border-secondary/20 font-bold text-xs"
                                                placeholder="e.g. hunarasaan.edu"
                                    ...
                                    <div className="md:col-span-2 space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input className="input-field pl-12 bg-slate-50 focus:bg-white border-transparent focus:border-secondary/20 font-bold text-xs" value={formData.address} onChange={e => setFormData({ ...formData, address: e.target.value })} />
                                        </div>
                                    </div>
                                </div>
                            </div>
