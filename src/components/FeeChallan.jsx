    ...
    <div style={styles.column(isLast)}>
      ...
      <div style={styles.header}>
        <div style={styles.logoRing}>
          ...
          <div style={{ ...styles.logoCircle, display: logoUrl ? 'none' : 'flex' }}>
      ...
      <div style={styles.sigBlock}>
        {signatureUrl ? (
          <img
            src={signatureUrl}
            alt="Signature"
            style={{ maxHeight: 36, maxWidth: 120, objectFit: 'contain', margin: '0 auto 2px', display: 'block' }}
          />
        ) : null}
        <div style={{ ...styles.sigLine, marginTop: signatureUrl ? 2 : 10 }}>{signatureTitle || 'Authorized Signature'}</div>
      </div>
