...
const checkStudentExists = async (req, res) => {
  try {
    ...
    const allowedFields = ['email', 'phone', 'cnic', 'customId', 'secondaryEmail', 'secondaryPhone'];
  ...
  try {
    ...
    if (userId) {
      ...
      await student.update({
        ...
        secondaryEmail: secondaryEmail !== undefined ? secondaryEmail : student.secondaryEmail,
        secondaryPhone: secondaryPhone !== undefined ? secondaryPhone : student.secondaryPhone,
        additionalContacts: additionalContacts !== undefined ? (typeof additionalContacts === 'string' ? additionalContacts : JSON.stringify(additionalContacts)) : student.additionalContacts,
