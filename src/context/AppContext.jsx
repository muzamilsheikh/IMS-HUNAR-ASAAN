...
export const AppProvider = ({ children }) => {
    ...
    const updateSettings = async (formData) => {
        try {
            ...
            if (updated) {
                // Merge response directly — server now returns the NEW signatureUrl / logoUrl
                // Do NOT fetchData here; the socket 'data-updated' event (fired after res.json)
                // will trigger a clean refetch after the DB write is committed.
